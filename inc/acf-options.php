...
function my_template_acf_mataboxes(){
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            ...
            array(
                'key' => 'equipment_base_boolean',
                'label' => 'Отображать таб?',
                'name' => 'equipment_base_boolean',
                'type' => 'true_false',
                'default_value' => 1,
                'ui' => 1,
                'ui_on_text' => 'Да',
            ...
            array(
                'key' => 'equipment_standard_boolean',
                'label' => 'Отображать таб?',
                'name' => 'equipment_standard_boolean',
                'type' => 'true_false',
                'default_value' => 1,
                'ui' => 1,
                'ui_on_text' => 'Да',
            ...
            array(
                'key' => 'equipment_profile_boolean',
                'label' => 'Отображать таб?',
                'name' => 'equipment_profile_boolean',
                'type' => 'true_false',
                'default_value' => 1,
                'ui' => 1,
                'ui_on_text' => 'Да',
